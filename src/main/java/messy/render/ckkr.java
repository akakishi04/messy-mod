...
public class ckkr implements IItemRenderer {

	private static final ResourceLocation[] resource     = {new ResourceLocation("tete:textures/items/cl.png")};

	private ckkm modeling;
    public ckkr(){
        modeling = new ckkm();
    }
